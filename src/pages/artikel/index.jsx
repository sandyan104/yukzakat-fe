    ...
    <>
              ...
              {artikels.map((artikel) => (
                <Grid item xs={12} md={6} lg={4} key={artikel.id_artikel}>
                  <Paper elevation={3} sx={{ padding: 2 }}>
                    <img src={artikel.hero_image} alt={artikel.judul} style={{ width: "100%", borderRadius: "8px" }} />
      ...
      >
        ...
        <Typography variant="body2" color="white" fontWeight={200}>
          Jl. Raya Katapang-Andir, Sangkanhurip, Katapang, Kab.Bandung Jl. Kebon Bibit Barat, Tamansari, Bandungwetan, Kota Bandung
        </Typography>
      </div>
    </>
  );
